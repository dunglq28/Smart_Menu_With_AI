...
import { formatCurrencyMenu, translateDemographics, validateMenu } from "@/utils";
...
const ModalFormCreateMenu: React.FC<ModalProps> = ({
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        const segments = await CustomerSegmentService.getCustomerSegmentsNoPaging(brandId);
