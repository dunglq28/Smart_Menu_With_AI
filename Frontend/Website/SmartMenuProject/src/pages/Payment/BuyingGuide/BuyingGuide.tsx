  ...
  return (
    <Box w="100%" h="100%" p={8} backgroundColor="#fff">
      <VStack spacing={6} align="stretch" maxWidth="1000px" mx="auto">
        ...
        <Text fontSize="xl">
          Bạn vui lòng chuyển khoản cho chúng tôi theo một trong các hình thức sau đây.
        </Text>

        <Text fontSize="xl">
          Sau khi xác nhận thông tin chuyển khoản, tài khoản của bạn sẽ được kích hoạt tự động. Nếu
          gặp bất kỳ vấn đề nào, bạn có thể liên hệ với chúng tôi qua fanpage hoặc gọi điện trực
          tiếp để được hỗ trợ.
        </Text>
        ...
        <VStack align="start" pl="20px" lineHeight={2}>
          <ul>
            ...
            <ul style={{ paddingLeft: 20 }}>
              ...
              <li>
                <Text fontSize="xl">Nội dung chuyển khoản: Tên + SĐT đặt hàng</Text>
              </li>
              <li>
                <Box>
                ...
                <Box id="collapseExtrabank1" className="accordion-collapse collapse show">
                  <img src={Images.qr} alt="QR Code" style={{ width: "320px" }} />
                </Box>
              </li>
            </ul>
          </ul>
        ...
        <Text fontSize="xl" textAlign="center">
          Khi đăng ký gói, bạn xác nhận đã đọc và đồng ý với Điều khoản và điều kiện giao dịch của
          Smart Menu.
        </Text>
