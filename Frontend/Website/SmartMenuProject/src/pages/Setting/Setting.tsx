...
function Setting() {
  ...
  const [headerSticky, setHeaderSticky] = useState<PositionValue>(getInitialHeaderSticky());

  // const toggleHeaderPosition = () => {
  //   const newHeaderSticky: PositionValue = headerSticky === "sticky" ? "relative" : "sticky";
      ...
      >
        <AlertDialogOverlay>
          <AlertDialogContent>
            ...
            <AlertDialogBody>Do you want to reload this page to see your change?</AlertDialogBody>
